...
Tags: sidebar, comment, Facebook, Twitter, weibo, 人人网, 开心网, 新浪微博, 腾讯微博, 微博连接, socila media connect
...
<p>支持Facebook、Twitter、人人网、开心网、新浪微博、腾讯微博、搜狐微博、网易微博、天涯微博、豆瓣、饭否、Follow5的连接登陆、文章同步、评论转发到微博等功能</p>
...
<p>V1.6功能
1.新增支持人人网、开心网、facebook与天涯账号支持。<br/>
2.bug修复<br/>
3.twitter支持同步图片<br/>
4.新增支持自定义类型文章<br/>
5.完全重写了账号注册流程，支持自定义用户名、邮箱、网址，并且兼容旧版本注册的用户。<br/>
</p>
...
增加图标式（正方形图标）登陆风格
= 1.6.12 =
增加单独的获取appkey的按钮。增加输入密码才能解绑账号功能。
= 1.6.11 =
解决部分用户无法连接到sae服务器获取appkey的问题。
= 1.6.10 =
限制用户名长度，防止恶意注册超长用户名
= 1.6.9 =
修复登陆页面无法成功登陆问题，更改发布页面meta box形式。
= 1.6.8 =
新增开心网支持账号绑定、评论同步等
= 1.6.7 =
新增人人网支持账号绑定、评论同步等
...
修复微博绑定到账号的bug
= 1.6.4 =
完善注册流程，增加 百度短网址(dwz.cn),修正用户注册通知管理员的邮件内容
= 1.6.3 =
完全重写了账号注册流程，支持自定义用户名、邮箱、网址，并且兼容旧版本注册的用户。
= 1.6.2 =
新增支持自定义类型文章，增强腾讯微博同步稳定性
= 1.6.1 =
bug修复, twitter支持同步图片
= 1.6 =
新增支持facebook与天涯账号支持。
